{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1221.0, 158.0, 692.0, 465.0 ],
		"bglocked" : 0,
		"defrect" : [ 1221.0, 158.0, 692.0, 465.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 90.0, 594.0, 103.0 ],
					"text" : "imp.dmx.rgbcmy converts RGB values to CMY, or CMY values to RGB. In both cases, the process is simply inverting the values. CMY values are used to specify subtractive rather than additive colour mixing and are required for colour-values to send to moving lights, which use subtractive colour filter wheels.\n\nThe object can convert floats betwen 0 and 1, or ints betweeen 0 and 255 if the @8bit attribute is set to 1. Values can be sent as a list of three values or as individual values in the corresponding inlets. Output is always in the form of a list."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 600.0, 430.0, 80.0, 20.0 ],
					"text" : "Blue/Yellow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.0, 430.0, 100.0, 20.0 ],
					"text" : "Green/Magenta"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 430.0, 70.0, 20.0 ],
					"text" : "Red/Cyan"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 420.0, 400.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 420.0, 360.0, 69.0, 20.0 ],
					"text" : "unpack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 600.0, 220.0, 80.0, 20.0 ],
					"text" : "Blue/Yellow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.0, 220.0, 100.0, 20.0 ],
					"text" : "Green/Magenta"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 220.0, 70.0, 20.0 ],
					"text" : "Red/Cyan"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 600.0, 250.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 510.0, 250.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 420.0, 250.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 330.0, 99.0, 20.0 ],
					"text" : "imp.dmx.rgbcmy"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 430.0, 150.0, 20.0 ],
					"text" : "CMY Output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 430.0, 150.0, 20.0 ],
					"text" : "CMY Output"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 410.0, 180.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 410.0, 180.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 210.0, 150.0, 20.0 ],
					"text" : "0 - 255 Values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 210.0, 150.0, 20.0 ],
					"text" : "0. - 1. Values"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 330.0, 150.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 330.0, 150.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 370.0, 143.0, 20.0 ],
					"text" : "imp.dmx.rgbcmy @8bit 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 210.0, 240.0, 180.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 10.0, 240.0, 180.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 370.0, 99.0, 20.0 ],
					"text" : "imp.dmx.rgbcmy"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 519.5, 290.0, 469.5, 290.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 609.5, 301.0, 509.5, 301.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 19.5, 401.0, 180.5, 401.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 479.5, 386.0, 609.5, 386.0 ],
					"source" : [ "obj-31", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 454.5, 393.0, 519.5, 393.0 ],
					"source" : [ "obj-31", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 19.5, 317.0, 180.5, 317.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"hidden" : 0,
					"midpoints" : [ 219.5, 318.0, 380.5, 318.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 219.5, 398.0, 380.5, 398.0 ],
					"source" : [ "obj-7", 0 ]
				}
