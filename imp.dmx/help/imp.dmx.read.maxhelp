{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 398.0, 142.0, 695.0, 602.0 ],
		"bglocked" : 0,
		"defrect" : [ 398.0, 142.0, 695.0, 602.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 450.0, 190.0, 48.0 ],
					"text" : "You can read out data in channel/value pairs with the @prefix attribute set to 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 10.0, 470.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 580.0, 670.0, 18.0 ],
					"text" : "485 152 486 151 487 150 488 149 489 148 490 148 491 147 492 146 493 145 494 144"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 510.0, 90.0, 20.0 ],
					"text" : "Start Address"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 110.0, 510.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 550.0, 276.0, 20.0 ],
					"text" : "imp.dmx.read 1 10 @matrix dmx.read.a @prefix 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 520.0, 370.0, 150.0, 48.0 ],
					"text" : "You can change the referenced matrix with the @matrix attribute."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 400.0, 91.0, 20.0 ],
					"text" : "prepend matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.0, 370.0, 71.0, 18.0 ],
					"text" : "dmx.read.b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.0, 340.0, 71.0, 18.0 ],
					"text" : "dmx.read.a"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 290.0, 190.0, 34.0 ],
					"text" : "You can continuously read out a whole universe by using qmetro."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 340.0, 460.0, 184.0, 80.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 270.0, 160.0, 184.0, 80.0 ],
					"prototypename" : "DMX Universe",
					"setminmax" : [ 0.0, 255.0 ],
					"settype" : 0,
					"size" : 512
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 270.0, 250.0, 206.0, 20.0 ],
					"text" : "imp.dmx.write 1 @matrix dmx.read.b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 340.0, 330.0, 65.0, 20.0 ],
					"text" : "qmetro 22"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 430.0, 228.0, 20.0 ],
					"text" : "imp.dmx.read 1 512 @matrix dmx.read.a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 400.0, 210.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 160.0, 60.0, 75.0 ],
					"text" : "Create some data by drawing here."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 310.0, 90.0, 20.0 ],
					"text" : "Start Address"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 120.0, 340.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 370.0, 221.0, 20.0 ],
					"text" : "imp.dmx.read 1 12 @matrix dmx.read.a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 10.0, 160.0, 184.0, 80.0 ],
					"prototypename" : "DMX Universe",
					"setminmax" : [ 0.0, 255.0 ],
					"settype" : 0,
					"size" : 512
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 10.0, 250.0, 206.0, 20.0 ],
					"text" : "imp.dmx.write 1 @matrix dmx.read.a"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 90.0, 578.0, 62.0 ],
					"text" : "This patch provides a list output of DMX from a jitter matrix. By default it references the matrix 'imp.dmx', allowing easy use for single universe projects. Alternatively, using the attribute @matrix a seperate matrix can be selected for output. Two arguments are required, the address of the first channel to be read from the matrix, and the length of the output list in number of channels.\n"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 620.0, 140.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 590.0, 90.0, 88.0, 32.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 590.0, 90.0, 88.0, 32.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 590.0, 90.0, 88.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 10.0, 675.0, 72.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 10.0, 675.0, 72.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 608.0, 8.0, 56.0, 56.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 560.0, 38.0, 40.0, 25.0 ],
									"text" : "V0.5",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 38.0, 592.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 3.0, 592.0, 43.0 ],
									"text" : "imp.dmx.read",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 672.0, 72.0 ],
...
,
					"patching_rect" : [ 10.0, 10.0, 675.0, 72.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 449.5, 363.0, 369.5, 363.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"hidden" : 0,
					"midpoints" : [ 449.5, 395.0, 369.5, 395.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 369.5, 425.0, 349.5, 425.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 19.5, 575.0, 670.5, 575.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 119.5, 541.0, 148.0, 541.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 19.5, 396.0, 210.5, 396.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 69.5, 364.0, 120.5, 364.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 2 ],
					"hidden" : 0,
					"midpoints" : [ 129.5, 365.0, 221.5, 365.0 ],
					"source" : [ "obj-9", 0 ]
				}
