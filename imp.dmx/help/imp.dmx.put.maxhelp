{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 871.0, 330.0, 696.0, 480.0 ],
		"bglocked" : 0,
		"defrect" : [ 871.0, 330.0, 696.0, 480.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 210.0, 150.0, 34.0 ],
					"text" : "Change the addresses to be written to."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 280.0, 73.0, 18.0 ],
					"text" : "1 3 5 7 9 11"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 250.0, 86.0, 18.0 ],
					"text" : "7 8 9 10 11 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 220.0, 67.0, 18.0 ],
					"text" : "1 2 3 4 5 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 310.0, 119.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 200.0, 20.0, 100.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 200.0, 20.0, 100.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 200.0, 20.0, 100.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 200.0, 20.0, 100.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 200.0, 20.0, 100.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 200.0, 20.0, 100.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 340.0, 93.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 470.0, 300.0, 211.0, 20.0 ],
					"text" : "imp.dmx.read 1 12@matrix dmx.put.b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 300.0, 214.0, 20.0 ],
					"text" : "imp.dmx.read 1 12 @matrix dmx.put.a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 470.0, 330.0, 150.0, 80.0 ],
					"setminmax" : [ 0.0, 255.0 ],
					"settype" : 0,
					"size" : 512
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 250.0, 330.0, 150.0, 80.0 ],
					"setminmax" : [ 0.0, 255.0 ],
					"settype" : 0,
					"size" : 12
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 380.0, 99.0, 18.0 ],
					"text" : "matrix dmx.put.b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 350.0, 99.0, 18.0 ],
					"text" : "matrix dmx.put.a"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 430.0, 423.0, 34.0 ],
					"text" : "Argument sets the initial channel addresses to write data at. Default is 1 2 3 4 5 6. @matrix attribute sets data source. Default is imp.dmx."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 410.0, 231.0, 20.0 ],
					"text" : "imp.dmx.put 1 2 3 @matrix dmx.get.a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 250.0, 270.0, 121.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.0, 140.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 90.0, 570.0, 103.0 ],
					"text" : "This patch is for writing the values of specific channels to a DMX Jitter matrix. By default it references 'imp.dmx' but the matrix can be changed with the @matrix attribute.\n\nThe channels to be written to are initially specified by the arguments, but can be changed by sending a list of ints to the right inlet. To write data, send a list of ints into the left inlet. These values will be written into the matrix at the respective addresses specified by the arguments. To write the same data again, send a bang to the left inlet."
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 149.5, 244.0, 231.5, 244.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 1 ],
					"hidden" : 0,
					"midpoints" : [ 149.5, 274.0, 231.5, 274.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 1 ],
					"hidden" : 0,
					"midpoints" : [ 149.5, 305.0, 231.5, 305.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"hidden" : 0,
					"midpoints" : [ 259.5, 294.0, 479.5, 294.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 0 ],
					"hidden" : 0,
					"midpoints" : [ 39.5, 403.0, 19.5, 403.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 0 ],
					"hidden" : 0,
					"midpoints" : [ 39.5, 373.0, 19.5, 373.0 ],
					"source" : [ "obj-46", 0 ]
				}
