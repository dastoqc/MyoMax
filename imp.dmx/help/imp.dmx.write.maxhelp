{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1182.0, 109.0, 693.0, 468.0 ],
		"bglocked" : 0,
		"defrect" : [ 1182.0, 109.0, 693.0, 468.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 170.0, 330.0, 20.0 ],
					"text" : "Send a list of six values and try changing the start channel."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 260.0, 203.0, 48.0 ],
					"text" : "The object will only write as much data as you send. The output matrix is only updated when writing."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 220.0, 269.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 550.0, 190.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 450.0, 190.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 400.0, 190.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 320.0, 390.0, 20.0 ],
					"text" : "jit.scanwrap and a pwindow are a good way of quickly visualising data."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 170.0, 90.0, 62.0 ],
					"text" : "Draw in the multislider to send some data"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 260.0, 120.0, 34.0 ],
					"text" : "Channel to start writing on."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 190.0, 260.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 10.0, 350.0, 670.0, 110.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 320.0, 137.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 10.0, 290.0, 199.0, 20.0 ],
					"text" : "imp.dmx.write 1 @matrix dmx.write"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 90.0, 572.0, 62.0 ],
					"text" : "imp.dmx.write writes DMX data into a jitter matrix. The resulting matrix is sent out the left outlet. The argument is the channel to start writing on. By default the object references the matrix 'imp.dmx', allowing quick and easy use for single universe projects. Alternatively, using the attribute @matrix a seperate matrix can be selected for output. The jitter matrix used is a single plane 1-dimensional 512 value char."
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 309.5, 249.0, 19.5, 249.0 ],
					"source" : [ "obj-21", 0 ]
				}
