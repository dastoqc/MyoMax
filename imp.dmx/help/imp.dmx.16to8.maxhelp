{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 450.0, 481.0, 642.0, 453.0 ],
		"bglocked" : 0,
		"defrect" : [ 450.0, 481.0, 642.0, 453.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 580.0, 390.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 390.0, 40.0, 20.0 ],
					"text" : "LSB"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 390.0, 40.0, 20.0 ],
					"text" : "MSB"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 430.0, 40.0, 20.0 ],
					"text" : "8-bit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 280.0, 40.0, 20.0 ],
					"text" : "Angle"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 300.0, 280.0, 70.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 250.0, 119.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 280.0, 310.0, 110.0, 110.0 ],
					"size" : 360.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 280.0, 40.0, 20.0 ],
					"text" : "Angle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 480.0, 280.0, 70.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 250.0, 132.0, 20.0 ],
					"text" : "scale 0. 65535. 0. 360."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 450.0, 220.0, 89.0, 20.0 ],
					"text" : "imp.dmx.8to16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 90.0, 370.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 140.0, 414.0, 62.0 ],
					"text" : "The example below shows the advantage of using 16-bit control. If the 8-bit range of a single DMX channel is mapped to control direction, the precision of control is greater than 1 degree. When using a 16-bit value range, the precision available is significantly greater."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 450.0, 310.0, 110.0, 110.0 ],
					"size" : 360.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 140.0, 45.0, 34.0 ],
					"text" : "16-bit value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 90.0, 520.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 140.0, 20.0, 140.0 ],
					"size" : 65536.0
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"hidden" : 0,
					"midpoints" : [ 29.5, 416.0, 225.0, 416.0, 225.0, 216.0, 289.5, 216.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 29.5, 416.0, 225.0, 416.0, 225.0, 216.0, 459.5, 216.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 99.5, 412.0, 215.0, 412.0, 215.0, 210.0, 529.5, 210.0 ],
					"source" : [ "obj-37", 0 ]
				}
