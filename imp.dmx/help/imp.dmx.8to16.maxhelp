{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 557.0, 273.0, 645.0, 435.0 ],
		"bglocked" : 0,
		"defrect" : [ 557.0, 273.0, 645.0, 435.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 580.0, 370.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 370.0, 80.0, 20.0 ],
					"text" : "16-bit value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.0, 410.0, 40.0, 20.0 ],
					"text" : "16-bit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 410.0, 40.0, 20.0 ],
					"text" : "8-bit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.0, 260.0, 40.0, 20.0 ],
					"text" : "Angle"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.0, 260.0, 40.0, 20.0 ],
					"text" : "Angle"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 470.0, 260.0, 70.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 310.0, 260.0, 70.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 230.0, 132.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 450.0, 290.0, 110.0, 110.0 ],
					"size" : 360.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 290.0, 290.0, 110.0, 110.0 ],
					"size" : 360.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 140.0, 40.0, 20.0 ],
					"text" : "LSB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 90.0, 290.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 140.0, 20.0, 140.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"text" : "imp.dmx.8to16 converts two 8-bit values (0-255), the MSB and LSB, into a 16-bit value (0-65535). This is useful when formatting DMX data from fixtures that use fine control channels."
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"hidden" : 0,
					"midpoints" : [ 29.5, 319.0, 262.0, 319.0, 262.0, 225.0, 299.5, 225.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"hidden" : 0,
					"midpoints" : [ 29.5, 399.0, 270.0, 399.0, 270.0, 221.0, 459.5, 221.0 ],
					"source" : [ "obj-22", 0 ]
				}
