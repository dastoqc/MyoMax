{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 795.0, 628.0, 452.0, 495.0 ],
		"bglocked" : 0,
		"defrect" : [ 795.0, 628.0, 452.0, 495.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.0, 20.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 350.0, 370.0, 88.0, 31.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 350.0, 370.0, 88.0, 31.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 350.0, 370.0, 88.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 290.0, 280.0, 62.0 ],
					"text" : "This patch prefixes channel numbers to a list of DMX values. Argument is the address of the first channel. Useful for fomatting data for the Enttec DMX USB Pro interface."
				}

			}
, 			{
				"box" : 				{
					"args" : [ "imp.dmx.prefix", 0.5, 430, 1 ],
					"embed" : 1,
					"id" : "obj-29",
					"maxclass" : "bpatcher",
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 410.0, 440.0, 80.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 410.0, 440.0, 80.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 368.0, 8.0, 56.0, 56.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 320.0, 38.0, 40.0, 25.0 ],
									"text" : "V0.5",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 38.0, 352.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 3.0, 352.0, 43.0 ],
									"text" : "imp.dmx.prefix",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 432.0, 72.0 ],
...
,
					"patching_rect" : [ 10.0, 410.0, 440.0, 80.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 210.0, 60.0, 20.0 ],
					"text" : "Data In"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 10.0, 90.0, 20.0 ],
					"text" : "Start Address"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 280.0, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.0, 230.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 230.0, 190.0, 65.0, 20.0 ],
					"text" : "split 1 512"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 160.0, 108.0, 20.0 ],
					"text" : "expr $i1 + ($i2 - 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 210.0, 90.0, 128.0, 20.0 ],
					"text" : "t b b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 230.0, 130.0, 59.0, 20.0 ],
					"text" : "uzi 512 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 310.0, 99.0, 20.0 ],
					"text" : "bondo 2 n"
				}
...
, 			{
				"box" : 				{
					"comment" : "DMX Universe with Channel Number Prefixed (list)",
					"id" : "obj-5",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "Single DMX Universe (list)",
					"id" : "obj-1",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 210.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 239.5, 221.0, 219.5, 221.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 219.5, 265.0, 29.5, 265.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 279.5, 155.0, 239.5, 155.0 ],
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 274.0, 123.0, 239.5, 123.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 159.5, 53.0, 219.5, 53.0 ],
					"source" : [ "obj-4", 0 ]
				}
