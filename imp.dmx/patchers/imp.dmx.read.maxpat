{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1056.0, 491.0, 777.0, 651.0 ],
		"bglocked" : 0,
		"defrect" : [ 1056.0, 491.0, 777.0, 651.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 700.0, 20.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 530.0, 110.0, 20.0 ],
					"text" : "DMX Output List"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 60.0, 70.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 40.0, 60.0, 34.0 ],
					"text" : "Start Address"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 260.0, 210.0, 46.0, 20.0 ],
					"text" : "t i b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 180.0, 350.0, 126.0, 20.0 ],
					"text" : "+ 0"
				}
...
, 			{
				"box" : 				{
					"comment" : "Start Address (int 1-512)",
					"id" : "obj-20",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 330.0, 420.0, 172.0 ],
					"text" : "This patch provides a list output of DMX from a jitter matrix. By default it references the matrix 'imp.dmx', allowing easy use for single universe projects. Alternatively, using the attribute @matrix a seperate matrix can be selected for output.\n\nTwo arguments are required, the address of the first channel to be read from the matrix, and the length of the output list in number of channels.\n\nThe attribute @prefix is when 1 will prepend each channel value with it's respective channel number. This provides the same functionality as imp.dmx.prefix. This mode is useful for outputting to certain hardware devices."
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 670.0, 530.0, 88.0, 31.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 670.0, 530.0, 88.0, 31.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 670.0, 530.0, 88.0, 31.0 ],
					"prototypename" : "ImpLicense"
				}

			}
, 			{
				"box" : 				{
					"args" : [ "imp.dmx.read", 0.5, 750, 1 ],
					"embed" : 1,
					"id" : "obj-29",
					"maxclass" : "bpatcher",
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 570.0, 760.0, 80.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 570.0, 760.0, 80.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 688.0, 8.0, 56.0, 56.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 328.0, 320.0, 40.0, 25.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 640.0, 38.0, 40.0, 25.0 ],
									"text" : "V0.5",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 38.0, 672.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 3.0, 672.0, 43.0 ],
									"text" : "imp.dmx.read",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 752.0, 72.0 ],
...
,
					"patching_rect" : [ 10.0, 570.0, 760.0, 80.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 140.0, 62.0, 20.0 ],
					"text" : "clip 1 512"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 310.0, 49.0, 20.0 ],
					"text" : "clip 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 140.0, 62.0, 20.0 ],
					"text" : "clip 1 512"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 20.0, 40.0, 107.0, 20.0 ],
					"text" : "route matrix prefix"
				}

			}
, 			{
				"box" : 				{
					"comment" : "Number of Channels (int 1-512)",
					"id" : "obj-7",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 500.0, 60.0, 188.0, 20.0 ],
					"text" : "route matrix prefix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 440.0, 75.0, 20.0 ],
					"text" : "bondo 2 n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 410.0, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 480.0, 75.0, 20.0 ],
					"text" : "zl 1024 lace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 140.0, 380.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 260.0, 180.0, 32.5, 20.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 250.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 370.0, 59.0, 20.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 250.0, 87.0, 20.0 ],
					"text" : "prepend offset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 260.0, 60.0, 119.0, 20.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 150.0, 88.0, 20.0 ],
					"text" : "prepend name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 260.0, 30.0, 259.0, 20.0 ],
					"text" : "patcherargs 1 512 @matrix imp.dmx @prefix 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 60.0, 190.0, 164.0, 20.0 ],
					"text" : "jit.matrix imp.dmx 1 char 512"
				}

			}
, 			{
				"box" : 				{
					"comment" : "DMX Output (list)",
					"id" : "obj-3",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 280.0, 98.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"hidden" : 0,
					"midpoints" : [ 117.5, 131.0, 69.5, 131.0 ],
					"source" : [ "obj-10", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 73.5, 110.0, 509.5, 110.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 369.5, 245.0, 179.5, 245.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 89.5, 274.0, 69.5, 274.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"hidden" : 0,
					"midpoints" : [ 219.5, 122.0, 269.5, 122.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 189.5, 375.0, 149.5, 375.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"hidden" : 0,
					"midpoints" : [ 269.5, 239.0, 89.5, 239.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 283.0, 312.0, 149.5, 312.0 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 69.5, 408.0, 125.5, 408.0 ],
					"source" : [ "obj-27", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 179.5, 274.0, 69.5, 274.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 594.0, 305.0, 29.5, 305.0 ],
					"source" : [ "obj-4", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 69.5, 511.0, 29.5, 511.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 149.5, 433.0, 69.5, 433.0 ],
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 469.5, 124.0, 369.5, 124.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 509.5, 173.0, 69.5, 173.0 ],
					"source" : [ "obj-8", 0 ]
				}
