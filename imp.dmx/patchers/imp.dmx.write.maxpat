{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1234.0, 545.0, 651.0, 393.0 ],
		"bglocked" : 0,
		"defrect" : [ 1234.0, 545.0, 651.0, 393.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 570.0, 200.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 10.0, 90.0, 20.0 ],
					"text" : "Start Address"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 170.0, 88.0, 20.0 ],
					"text" : "prepend name"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 360.0, 250.0, 164.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 440.0, 20.0, 205.0, 144.0 ],
					"text" : "This patcher writes DMX data into a jitter matrix. By default it references the matrix 'imp.dmx', allowing easy use for single universe projects. Alternatively, using the attribute @matrix a seperate matrix can be selected for output.\n\nThe only argument is the channel to start writing data on."
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 540.0, 270.0, 88.0, 31.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 540.0, 270.0, 88.0, 31.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 540.0, 270.0, 88.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 310.0, 630.0, 80.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 310.0, 630.0, 80.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
,
					"patching_rect" : [ 10.0, 310.0, 630.0, 80.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 100.0, 62.0, 20.0 ],
					"text" : "clip 1 512"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 170.0, 127.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 170.0, 87.0, 20.0 ],
					"text" : "prepend offset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 360.0, 100.0, 74.0, 20.0 ],
					"text" : "route matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 190.0, 60.0, 189.0, 20.0 ],
					"text" : "patcherargs 1 @matrix imp.dmx"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 130.0, 140.0, 32.5, 20.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					"comment" : "Start Channel (int 0-512)",
					"id" : "obj-3",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 70.0, 210.0, 93.0, 20.0 ],
					"text" : "jit.fill imp.dmx 0"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 79.5, 237.0, 369.5, 237.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 239.5, 204.0, 79.5, 204.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 199.5, 90.0, 139.5, 90.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 369.5, 147.0, 239.5, 147.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 139.5, 204.0, 79.5, 204.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 19.5, 130.0, 239.5, 130.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 19.5, 130.0, 369.5, 130.0 ],
					"source" : [ "obj-9", 0 ]
				}
