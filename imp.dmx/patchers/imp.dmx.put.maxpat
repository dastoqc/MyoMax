{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 621.0, 305.0, 564.0, 452.0 ],
		"bglocked" : 0,
		"defrect" : [ 621.0, 305.0, 564.0, 452.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.0, 260.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 10.0, 233.0, 213.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 240.0, 240.0, 146.0, 20.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 240.0, 110.0, 69.0, 20.0 ],
					"text" : "zl 512 reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 240.0, 180.0, 75.0, 20.0 ],
					"text" : "zl 1024 lace"
				}
...
, 			{
				"box" : 				{
					"comment" : "Channel addresses to write to (list)",
					"id" : "obj-23",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 300.0, 146.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 130.0, 88.0, 20.0 ],
					"text" : "prepend name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 50.0, 10.0, 231.0, 20.0 ],
					"text" : "patcherargs 1 2 3 4 5 6 @matrix imp.dmx"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 460.0, 330.0, 88.0, 31.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 460.0, 330.0, 88.0, 31.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 460.0, 330.0, 88.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 370.0, 550.0, 80.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 370.0, 550.0, 80.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 480.0, 8.0, 56.0, 56.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 432.0, 38.0, 40.0, 25.0 ],
									"text" : "V0.5",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 38.0, 464.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 3.0, 464.0, 43.0 ],
									"text" : "imp.dmx.put",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 544.0, 72.0 ],
...
,
					"patching_rect" : [ 10.0, 370.0, 550.0, 80.0 ],
...
, 			{
				"box" : 				{
					"comment" : "Channel values to write (list)",
					"id" : "obj-1",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 59.5, 92.0, 299.5, 92.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 271.5, 82.0, 19.5, 82.0 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 153.0, 160.0, 305.5, 160.0 ],
					"source" : [ "obj-28", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-27", 0 ],
					"hidden" : 0,
					"midpoints" : [ 139.5, 155.0, 232.0, 155.0, 232.0, 103.0, 249.5, 103.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"hidden" : 0,
					"midpoints" : [ 19.5, 324.0, 249.5, 324.0 ],
					"source" : [ "obj-8", 0 ]
				}
