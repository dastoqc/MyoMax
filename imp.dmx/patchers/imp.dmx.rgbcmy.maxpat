{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1273.0, 509.0, 446.0, 433.0 ],
		"bglocked" : 0,
		"defrect" : [ 1273.0, 509.0, 446.0, 433.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 240.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 40.0, 60.0, 34.0 ],
					"text" : "Blue/\nYellow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 40.0, 60.0, 34.0 ],
					"text" : "Green/\nMagenta"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 40.0, 70.0, 34.0 ],
					"text" : "RGB/CMY List"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 290.0, 311.0, 48.0 ],
					"text" : "This patch converts either a list or three discreet RGB or CMY values into the opposite colour type. The attribute @8bit uses 0-255 values rather than 0.-1. values."
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 350.0, 310.0, 88.0, 31.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 350.0, 310.0, 88.0, 31.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 350.0, 310.0, 88.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 350.0, 430.0, 80.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 350.0, 430.0, 80.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 360.0, 8.0, 56.0, 56.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 312.0, 38.0, 40.0, 25.0 ],
									"text" : "V0.5",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 38.0, 344.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 8.0, 3.0, 344.0, 43.0 ],
									"text" : "imp.dmx.rgbcmy",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 424.0, 72.0 ],
...
,
					"patching_rect" : [ 10.0, 350.0, 430.0, 80.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 260.0, 239.0, 20.0 ],
					"text" : "pak f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 310.0, 40.0, 61.0, 20.0 ],
					"text" : "route 8bit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 350.0, 180.0, 37.0, 20.0 ],
					"text" : "t 255"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 310.0, 180.0, 24.0, 20.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 310.0, 150.0, 98.0, 20.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 310.0, 10.0, 119.0, 20.0 ],
					"text" : "patcherargs @8bit 0"
				}

			}
, 			{
				"box" : 				{
					"comment" : "Blue/Yellow (int/float)",
					"id" : "obj-14",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 220.0, 89.0, 20.0 ],
					"text" : "expr ($i2 - $f1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 220.0, 89.0, 20.0 ],
					"text" : "expr ($i2 - $f1)"
				}
...
, 			{
				"box" : 				{
					"comment" : "Green/Magenta (float/int)",
					"id" : "obj-11",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 220.0, 100.0, 34.0 ],
...
, 			{
				"box" : 				{
					"comment" : "Red/Cyan or RGB/CMY list (float/int)",
					"id" : "obj-1",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"hidden" : 0,
					"midpoints" : [ 419.5, 34.0, 319.5, 34.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 319.5, 206.0, 100.5, 206.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 319.5, 206.0, 199.5, 206.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 319.5, 206.0, 309.5, 206.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 1 ],
					"hidden" : 0,
					"midpoints" : [ 359.5, 211.0, 100.5, 211.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 1 ],
					"hidden" : 0,
					"midpoints" : [ 359.5, 211.0, 199.5, 211.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 1 ],
					"hidden" : 0,
					"midpoints" : [ 359.5, 211.0, 309.5, 211.0 ],
					"source" : [ "obj-18", 0 ]
				}
