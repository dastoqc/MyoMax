{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 706.0, 259.0, 446.0, 424.0 ],
		"bglocked" : 0,
		"defrect" : [ 706.0, 259.0, 446.0, 424.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 270.0, 56.0, 56.0 ],
					"pic" : "impdmxlogo.png"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 180.0, 49.0, 20.0 ],
					"text" : "t clear i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 110.0, 49.0, 34.0 ],
					"text" : "t dump clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 10.0, 50.0, 119.0, 20.0 ],
					"text" : "route clear autoclear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 210.0, 59.0, 20.0 ],
					"text" : "gate 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 290.0, 70.0, 91.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 160.0, 40.0, 149.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 300.0, 120.0, 20.0 ],
					"text" : "Full Universe in List"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 10.0, 110.0, 20.0 ],
					"text" : "Prefixed Data List"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 300.0, 88.0, 31.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 300.0, 88.0, 31.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 340.0, 430.0, 80.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 340.0, 430.0, 80.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
,
					"patching_rect" : [ 10.0, 340.0, 430.0, 80.0 ],
...
, 			{
				"box" : 				{
					"comment" : "Full DMX Universe (list)",
					"id" : "obj-35",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 210.0, 150.0, 61.0, 20.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.0, 270.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 110.0, 90.0, 119.0, 20.0 ],
					"text" : "t clear dump l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.0, 120.0, 79.0, 20.0 ],
					"text" : "zl 1024 iter 2"
				}
...
, 			{
				"box" : 				{
					"comment" : "Prefixed DMX Data (list)",
					"id" : "obj-11",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"hidden" : 0,
					"midpoints" : [ 169.5, 227.0, 219.5, 227.0 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"hidden" : 0,
					"midpoints" : [ 49.5, 233.0, 219.5, 233.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 299.5, 173.0, 49.5, 173.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"hidden" : 0,
					"midpoints" : [ 79.5, 233.0, 219.5, 233.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"hidden" : 0,
					"midpoints" : [ 69.5, 173.0, 49.5, 173.0 ],
					"source" : [ "obj-6", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"hidden" : 0,
					"midpoints" : [ 49.5, 153.0, 19.0, 153.0, 19.0, 233.0, 219.5, 233.0 ],
					"source" : [ "obj-7", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"hidden" : 0,
					"midpoints" : [ 19.5, 233.0, 219.5, 233.0 ],
					"source" : [ "obj-7", 0 ]
				}
